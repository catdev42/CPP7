...
// A "reader" function: It promises not to change the element.
// It works with both const and non-const data.
void printValue(const int& val) {
    std::cout << val << " ";
}

// A "writer" function: It needs to change the element: 
//non const
...
int main() {
    ...
    iter(const_numbers, const_len, printValue);
    std::cout << std::endl;
